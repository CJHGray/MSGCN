...
def load_data(path="../data/dblp/", dataset="dblp"):
    ...
    edges_unordered_a = np.genfromtxt("{}{}_meta_2.cites".format(path, dataset),
                                    dtype=np.int32)
    ...
    # build graph_b
    edges_unordered_b = np.genfromtxt("{}{}_meta_13.cites".format(path, dataset),
                                    dtype=np.int32)
    ...
    return degree_a, degree_b, adj_a, adj_b, features, labels, idx_train, idx_val, idx_test
